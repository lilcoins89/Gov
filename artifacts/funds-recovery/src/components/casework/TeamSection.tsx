  ...
  return (
    <section id="team" className="bg-navy-900 py-20 text-white lg:py-28">
      <div className="mx-auto grid max-w-7xl gap-12 px-5 lg:grid-cols-[.85fr_1.15fr] lg:items-center lg:px-8">
        ...
        <div className="relative overflow-hidden rounded-3xl border border-white/15"><img src="/recovery-team.jpg" alt="Recovery specialists collaborating in a modern office" className="h-80 w-full object-cover lg:h-[25rem]" /><div className="absolute inset-0 bg-gradient-to-t from-navy-950/75 via-transparent to-transparent" /><div className="absolute bottom-5 left-5 right-5 flex items-end justify-between"><div><p className="text-xs font-bold uppercase tracking-[0.14em] text-teal-300">Casework team</p><p className="mt-1 font-display text-xl font-bold">Experienced. Accountable. Present.</p></div><div className="grid h-11 w-11 place-items-center rounded-full bg-teal-300 text-navy-900"><Quote size={18} /></div></div></div>
      </div>
    </section>
  );
}